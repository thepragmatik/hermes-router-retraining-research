...
|---|---|---|---|---|---|---|
| 101 | Counterfactual Shadow Telemetry | randomized sentinels + known propensities + joinable outcomes | learning substrate; does not train the final router | none | survived-research | [`../101-counterfactual-shadow-telemetry/spec.md`](../101-counterfactual-shadow-telemetry/spec.md) |
